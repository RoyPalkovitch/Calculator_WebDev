let science = false;
const buttonsLeft = () => {
    let buttonArrayLeft = document.getElementById('left').children[0].children;
...
const buttonsCenter = () => {
    ...
    for (let i = 2; i < buttonArrayCenter.length; i++) {
        if (i === 2) {
            ...
            let rows = buttonArrayCenter[i].children;
...
const buttonsRight = () => {
    let buttonArrayRight = document.getElementById('right').children[0].children;
...
function toggle_view(tag, should_active) {
